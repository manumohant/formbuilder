...
! function(A) {
        ...
        var E = t(35),
            ...
            Q = function A(e, t) {
                ...
                if (e.showActionButtons) {
                    var W = e.actionButtons.map(function(A) {
                        ...
                        K = E.formActions = D("div", W, {
                            className: "form-actions btn-group visible-print-block 	"
                        });
                    V.appendChild(K)
                }
                ...
                var _ = function() {
                    ...
                    rA = function(A) {
                        var e = ["required", "label", "description", "placeholder", "className", "name", 
                                //"access", 
                                "value"],
                            ...
                            o = {
                                ...
                                checkbox: ["required", "label", "description", "toggle", "inline", "className", "name", 
                                //"access", 
                                "other", "options"],
                                ...
                                number: e.concat(["currency","min", "max", "step"]),
                    ...
                    oA = function(A) {
                        var t = A.type,
                            ...
                            n = {
                                ...
                                currency: function() {
                                    return `<div class="form-group subtype-wrap">
                                    <label for="currency-`+h.lastID+`">Currency</label>
                                    <div class="input-wrap">
                                        <select onchange="detect('`+h.lastID+`')"  id="currency-`+h.lastID+`" name="currencytype" class="fld-currency form-control">
                                    ...
                                    <script>
                                    function detect(id){
                                        var curval = document.getElementById('label-'+id).innerHTML;
                                        var split = curval.split('(');
                                        var cur = document.getElementById('currency-`+h.lastID+`').value;
                                        document.getElementById('label-'+id).innerHTML = split[0]+' ('+cur+')';
                ...
                if (N.on("click touchstart", ".remove", function(A) {
                        ...
                        if (A.target.classList.contains("fld-label")) {
                            console.log(A);
                            var current_id = A.target.id;
                            current_id = current_id.replace("label-frmb-","name-frmb-");
                            //var textval = A.target.innerHTML.replace("")
                            var plain_text = A.target.innerText;
                            //plain_text=plain_text.replace(/ /g,'_');
                            document.getElementById(current_id).value=plain_text;
                            //$("#"+current_id).trigger("change");
                            $("#"+current_id).trigger("blur");
                            //label-frmb-1516180924286-fld-1
    ...
    51: function(A, e) {
        ...
        var r = e.instanceDom = {},
            o = e.defaultSubtypes = {
                text: ["text", "password", "email", "color", "tel","time"],
                header: ["h1", "h2", "h3"],
    ...
    52: function(A, e) {
        ...
        e.defaultOptions = {
            ...
            actionButtons: [],
            controlOrder: [
                "text","select","textarea","date","checkbox","checkbox-group","radio-group","number","header","paragraph"
                ,'time','currency'
                //"autocomplete", 
            //"button", 
            //"file", 
            ...
            preloaded: {
                "en-US": {
                    ...
                    button: "Button",
                    cannotBeEmpty: "Avoid using special characters like %,&",
                    ...
                    getStarted: "Drag a field from the left to this area",
                    header: "Header",
                    hide: "Edit",
                    hidden: "Hidden Input",
                    inline: "Inline",
